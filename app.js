new Vue({
  ...
  methods: {
    calculateTaxes() {
      ...
      this.coupleTaxes = this.calculateTaxesForIncome(totalTaxableIncome);
      ...
      this.totalTaxesWithPacs = this.coupleTaxes.reduce((total, tax) => total + tax.impot, 0) * this.familyParts;
